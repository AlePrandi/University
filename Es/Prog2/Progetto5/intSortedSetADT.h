...
// restituisce l'elemento minimo, restituisce false se l'insieme è NULL oppure è vuoto
_Bool sset_min(const IntSortedSetADT, int *);

// restituisce l'elemento massimo, restituisce false se l'insieme è NULL oppure è vuoto
